<template>
  <div class='page-content'>
    ...
    <el-table border style="margin-top: 15px" :data="roleList" :showPage="false">
      ...
      <el-table-column label="登陆IP" prop="login_ip"/>
      <el-table-column label="地址" prop="address"/>
      <el-table-column label="登陆设备" prop="login_equipment"/>
      <el-table-column label="登陆时间" prop="login_time"/>
...
<script>
  import {getLoginListApi} from '@/api/LoginlogApi'
  export default {
    data () {
      return {
        allpage:1,//总页数
