<template>
  <div class='page-content'>
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-date-picker v-model="searchParameter.end" format="yyyy-MM-dd HH:mm:ss" @change="handleEndDate()" @keydown.enter.capture.native="handleEndDate()" type="date" placeholder="结束日期">
        </el-date-picker>
      </el-col>
      <el-col :span="5" class="el-col2">
...
export default {
  ...
  methods: {
    ...
    */
    ...
    getUserList(){
      getPayListApi({create_time_sort:this.create_time_sort,start: this.searchParameter.start,
